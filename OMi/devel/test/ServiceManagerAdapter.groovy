...
import test.AstelitRulesSection
...
public class ServiceManagerAdapter {
	...
	// then be synchronized to a corresponding SM property whenever the event property is changed in OMi.
	//
	private static final Set SyncOPRPropertiesToSMActivityLog = [
		"title",
		"description",
		"state",
		"severity",
	...
	//
	private static final Set SyncSMPropertiesToOPR = [
		"incident_status",
		"solution"
	]
	...
	private static final String NODE_FQDN = 'node_fqdn'
	private static final String NODE_RTSM_ID= 'node_rtsm_id'
	 ...
	 */
	private static final int descriptionLength = 15;
	...
	void updateCustomAttributes(String eventId, GPathResult respIncident, def args) {
		if ((m_oprVersion > 920) && !MapSM2OPRCustomAttribute.empty) {
			...
			MapSM2OPRCustomAttribute.each() { String smPropertyName, String caName ->
	...
	public String toExternalEvent(final OprEvent event,
		...
		boolean astl_operational_device = false
		...
		//TODO integrate AstelitRules Section
		//#======================Java modules=============================#//
		AstelitRulesSection  ars = new AstelitRulesSection(MapOPR2SMUrgency, event, externalRefId, causeExternalRefId, duplicateChange,
				isNewIncident, default_flag, astl_assignment_group, astl_logical_name, astl_priority, astl_urgency, astl_title, astl_description, astl_category,
				astl_sub_category, astl_operational_device, m_log);
		ars.process();
		if (m_log.isDebugEnabled()){
			String arsDebug = "AstelitRulesSection vars:\n" + ars.astl_assignment_group + "\n" + ars.default_flag + "\n" + ars.astl_related_ci;

			m_log.debug(arsDebug);
		}
		//#======================End of Java modules=============================#//
		...
		//========================Create XML params ============================//
		XMLParams xmlp = new XMLParams(INCIDENT_XML_NAMESPACE, INCIDENT_TAG, TITLE_TAG, DESCRIPTION_TAG, REFERENCE_NUMBER_TAG, INCIDENT_STATUS_TAG,COMPLETION_CODE_TAG,URGENCY_TAG,PRIORITY_TAG,SOLUTION_TAG, OWNER_TAG, ASSIGNED_TAG, ASSIGNED_GROUP_TAG, FUNCTIONAL_GROUP_TAG, RECORDED_BY_TAG, REQUESTED_BY_TAG, PARTY_TAG, PERSON_TAG, UI_NAME_TAG, NAME_TAG, EXTERNAL_PROCESS_ID_TAG, IMPACT_SCOPE_TAG, CONFIGURATION_ITEM_TAG, CATEGORY_TAG, SUB_CATEGORY_TAG, CI_RELATIONSHIP, CI_TARGET_TYPE_TAG, CI_GLOBALID_TAG, CI_TYPE_TAG, CI_ID_TAG, CI_NAME_TAG, CI_DISPLAY_LABEL_TAG, AFFECTS_RELATIONSHIP, NODE_RELATIONSHIP, NODE_DNS_NAME_TAG, ACTIVITY_LOG_TAG, ACTIVITY_LOG_DESC_TAG, ACTIVITY_LOG_ANNO_TAG, IS_CAUSED_BY, MASTER_REFERENCE_TAG, OPERATIONAL_DEVICE_TAG, NODE_RTSM_ID, IS_CAUSED_BY_ROLE, IMPACT_LABEL_VALUE, IT_PROCESS_CATEGORY, INCIDENT_TYPE, IMPACT_SCOPE, INCIDENT_XML_VERSION, INCIDENT_XML_TYPE, CI_TARGET_TYPE, CONFIGURATION_ITEM_ROLE, BUSINESS_SERVICE_ROLE, NODE_ITEM_ROLE, INCIDENT_XML_RELATIONSHIPS, TYPE_BUSINESS_SERVICE, REL_IMPACT, ATTR_GLOBAL_ID, ATTR_NAME, ATTR_LABEL, ATTR_BUSINESS_CRITICALITY, SET_COOKIE_HEADER, ASTELIT_CATEGORY, ASTELIT_SUB_CATEGORY, descriptionLength);
		//========================End XML params creation =====================///

		//========================Create Localization params ============================//
		LocalizationParams localp = new LocalizationParams(SMURGENCY ,  SMPRIORITY ,  LOCALE ,  ANNOTATION_DATE_FORMAT ,  EMPTY_DESCRIPTION_OVERRIDE ,  ACTIVITY_LOG_TITLE ,  ACTIVITY_LOG_TITLE_CHANGE ,  ACTIVITY_LOG_STATE ,  ACTIVITY_LOG_STATE_CHANGE ,  ACTIVITY_LOG_DESCRIPTION ,  ACTIVITY_LOG_DESCRIPTION_CHANGE ,  ACTIVITY_LOG_SOLUTION ,  ACTIVITY_LOG_SOLUTION_CHANGE ,  ACTIVITY_LOG_ASSIGNED_USER ,  ACTIVITY_LOG_ASSIGNED_USER_CHANGE ,  ACTIVITY_LOG_ASSIGNED_GROUP ,  ACTIVITY_LOG_ASSIGNED_GROUP_CHANGE ,  ACTIVITY_LOG_UNASSIGNED ,  ACTIVITY_LOG_SEVERITY ,  ACTIVITY_LOG_SEVERITY_CHANGE ,  ACTIVITY_LOG_PRIORITY ,  ACTIVITY_LOG_PRIORITY_CHANGE ,  ACTIVITY_LOG_CONTROL_TRANSFERRED_TO ,  ACTIVITY_LOG_CONTROL_TRANSFERRED_TO_CHANGED ,  ACTIVITY_LOG_CATEGORY ,  ACTIVITY_LOG_SUBCATEGORY ,  ACTIVITY_LOG_APPLICATION ,  ACTIVITY_LOG_OBJECT ,  ACTIVITY_LOG_ANNOTATION ,  ACTIVITY_LOG_CA ,  ACTIVITY_LOG_CAUSE ,  ACTIVITY_LOG_OMI_CAUSE ,  ACTIVITY_LOG_OMI_SYMPTOM ,  ACTIVITY_LOG_DUPLICATE_COUNT ,  ACTIVITY_LOG_PREVIOUS ,  ACTIVITY_LOG_CURRENT ,  ACTIVITY_LOG_INITIATED_BY ,  ACTIVITY_LOG_INITIATED_BY_RULE ,  ACTIVITY_LOG_INITIATED_BY_USER ,  ACTIVITY_LOG_RELATED_CI ,  ACTIVITY_LOG_RELATED_CI_TYPE_LABEL ,  ACTIVITY_LOG_RELATED_CI_TYPE ,  ACTIVITY_LOG_RELATED_CI_LABEL ,  ACTIVITY_LOG_RELATED_CI_NAME ,  ACTIVITY_LOG_RELATED_CI_HOSTED_ON ,  ACTIVITY_LOG_RELATED_CI_URL ,  ACTIVITY_LOG_AFFECTS_SERVICES ,  ACTIVITY_LOG_TIME_RECEIVED ,  ACTIVITY_LOG_TIME_CREATED ,  ACTIVITY_LOG_TIME_STATE_CHANGED ,  ACTIVITY_LOG_ORIGINAL_DATA ,  ACTIVITY_LOG_OPERATIONAL_DATA ,  UCMDBPROVIDER ,  UCMDBSERVICE ,  SAVETQLQUERY ,  SPECIFYACTIVEPROCESS ,  SPECIFYIMPACTSCOPE ,  DRILLDOWN_ROOT_PATH ,  OMI_ROOT_DRILLDOWN_PATH ,  BSM_CI_DRILLDOWN_PATH ,  ROOT_PATH ,  PING_QUERY ,  INCIDENT_PATH ,  CUSTOM_PROPERTIES_FILE);
		//========================End Localization params ============================//
		
		//========================Create Configuration XML params ============================//
		ConfigurationParams confp = new ConfigurationParams(sM_WEB_TIER_NAME ,  bSM_ADMINISTRATOR_LOGIN_NAME ,  rTSM_PORT ,  rTSM_MAX_CI_COUNT ,  rTSM_HOSTNAME ,  rTSM_USERNAME ,  rTSM_PASSWORD ,  rTSM_QUERY_MAX_STEPS ,  mAX_DUPLICATE_COUNT_UPDATES ,  mapOPR2SMStatus ,  mapSM2OPRState ,  mapOPR2SMUrgency ,  mapSM2OPRSeverity ,  mapOPR2SMPriority ,  mapSM2OPRPriority ,  sMCompletionCode ,  syncAllProperties ,  useNodeCI ,  recursiveSearchBusinessServices ,  disableCheckCloseOnUpdate ,  syncOPRPropertiesToSM ,  syncOPRPropertiesToSMActivityLog ,  syncSMPropertiesToOPR ,  syncOPRStatesToSM ,  syncOPRSeveritiesToSM ,  syncOPRPrioritiesToSM ,  syncSMStatusToOPR ,  syncSMUrgenciesToOPR ,  syncSMPrioritiesToOPR ,  mapOPR2SMCustomAttribute ,  mapSM2OPRCustomAttribute );
		//========================End XML params ============================//
		...
		if (!default_flag) {
			...
			if (description != null && description.length() > descriptionLength) {
				description = description.substring(0, descriptionLength - 1)
			}
		...
		if (default_flag) {
			...
			//TODO truncate default section description

			if (description != null && description.length() > descriptionLength) {
				description = description.trim().substring(0, descriptionLength - 1)
			}
			...
			xmlns: "${INCIDENT_XML_NAMESPACE}") {
				...
				activityLog.append('\n').append(ACTIVITY_LOG_OPERATIONAL_DATA).append('\n').
						append(astl_operational_device).append('\n')
				//TODO default section is new incident
